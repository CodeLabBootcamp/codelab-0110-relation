                ...
                <div class="card-body">
                    <form action="/dashboard/posts/{{$post->id}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{old('image',$post->image)}}" name="image" type="text" class="form-control" id="image"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="writer_id" data-style="btn btn-link" id="writer_id">
                                @foreach($writers as $writer)
                                    <option {{$post->writer_id == $writer->id ? "selected" : ""}} value="{{$writer->id}}">{{$writer->name}}</option>
                                @endforeach
                            </select>
                        </div>
